...
g = {}
with open(os.path.join('..', 'reana_workflow_monitor', 'version.py'), 'rt') as fp:
    exec(fp.read(), g)
...
html_theme_options = {
    'logo': 'logo-reana.png',
    'description': """<p>REANA-Workflow-Monitor is a component of the <a
                      href="http://www.reana.io">REANA</a> reusable and
                      reproducible research data analysis
                      platform.</p><p>REANA-Workflow-Monitor enables to monitor
                      running computational workflows.</p>""",
    'github_user': 'reanahub',
    'github_repo': 'reana-workflow-monitor',
    'github_button': False,
    'github_banner': True,
